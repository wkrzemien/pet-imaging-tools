...
from pet_imaging_tools.castor_datafile.transformation import write_row, get_flags, get_dtype, CASToRCDFField
...
Isotope: unknown'''
      ...
      with open(output_cdh, 'r+', encoding='utf-8') as cdh_file:
        ...
        with open(output_cdf, 'rb') as cdf_file:
          ...
          self.assertTrue(len(cdf_df) == n_rows)

  def test_replicate_file_not_found(self):
