...
the metadata contained in the header (*.Cdh), but also on the binary data defined in the CASTOR datafile
itself.

This module also defines a set of operations designed to be used directly from the command line. These operations allow to easily edit CASToR datafiles, for instance by:
...
One can create additional tools using the set of building blocks that allow to parse CASToR datafile headers, load its data into memory, and write edited data to the disk.
